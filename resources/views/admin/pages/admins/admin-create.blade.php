                            ...
                            <form method="POST" action="{{route('admin-save')}}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="" placeholder="Enter email">
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" id="" placeholder="Enter email">
                                        @error('phone')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
